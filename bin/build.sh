...
function push {
    NAME=$1
    DOCKER_HUB=etcdev/ecip1017-$NAME

    docker tag $ORG/ecip1017-$NAME $DOCKER_HUB:latest
    gcloud docker -- push $DOCKER_HUB:latest
    #docker tag $ORG/ecip1017-$NAME $DOCKER_HUB:$VERSION
